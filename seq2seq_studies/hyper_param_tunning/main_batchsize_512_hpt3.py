...
def train_model(model, X, Y, learning_rate, output_steps, batch_size, train_idx, valid_idx, test_idx, dropout_rate, hidden_dim, test=False, return_pred=False):
    ...
    model_path = '/models-vol3/trained_model_{}_{}_{}.pth'.format(learning_rate, dropout_rate, hidden_dim)
    results_path = '/models-vol3/results_dict_{}_{}_{}.pkl'.format(learning_rate, dropout_rate, hidden_dim)
