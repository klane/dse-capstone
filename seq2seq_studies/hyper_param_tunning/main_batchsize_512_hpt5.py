...
def train_model(model, X, Y, learning_rate, output_steps, batch_size, train_idx, valid_idx, test_idx, dropout_rate, hidden_dim, test=False, return_pred=False):
    ...
    model_path = '/models-vol5/trained_model_{}_{}_{}.pth'.format(learning_rate, dropout_rate, hidden_dim)
    results_path = '/models-vol5/results_dict_{}_{}_{}.pkl'.format(learning_rate, dropout_rate, hidden_dim)
...
def write_log(msg):
    ...
    with open('/models-vol5/training_logger.log', "a+") as f:
...
learning_rate = [0.0001, 0.1, 0.1, 0.1]
dropout_rate = [0.4, 0.2, 0.6, 0.4]
hidden_dim = [320, 64, 256, 192]
